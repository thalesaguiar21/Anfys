...
def test_bell_two():
	...
	print 'Memebership degree... {}'.format('Passed!' if in_range else 'Wrong!')
	if not in_range:
		hits -= 1
	...
	in_range = is_closed(result, expected, limit)
	print 'Derivative at {} relative to \'a\'... {}'.format(value, 'Passed!' if in_range else 'Wrong!')
	if not in_range:
		hits -= 1
		print 'Expected {}, result was {} '.format(expected, result)
	...
	in_range = is_closed(result, expected, limit)
	print 'Derivative at {} relative to \'b\'... {}'.format(value, 'Passed!' if in_range else 'Wrong!')
	if not in_range:
		hits -= 1
		print 'Expected {}, result was {} '.format(expected, result)
	...
	in_range = is_closed(result, expected, limit)
	print 'Derivative at {} relative to \'c\'... {}'.format(value, 'Passed!' if in_range else 'Wrong!')
	if not in_range:
		hits -= 1
		print 'Expected {}, result was {} '.format(expected, result)
