...
class TestTconorm(unittest.TestCase):
    ...
    def test_fmax_none(self):
        self.raising_tconorm(tconorm.fmax, None, 3, TypeError)
        self.raising_tconorm(tconorm.fmax, None, None, TypeError)
        self.raising_tconorm(tconorm.fmax, 0, None, TypeError)
    ...
    def test_prob_none(self):
        self.raising_tconorm(tconorm.probabilistic_sum, None, 3, TypeError)
        self.raising_tconorm(tconorm.probabilistic_sum, None, None, TypeError)
        self.raising_tconorm(tconorm.probabilistic_sum, 0, None, TypeError)
    ...
    def test_bounded_none(self):
        self.raising_tconorm(tconorm.bounded_sum, None, 3, TypeError)
        self.raising_tconorm(tconorm.bounded_sum, None, None, TypeError)
        self.raising_tconorm(tconorm.bounded_sum, 0, None, TypeError)
    ...
    def test_drastic_none(self):
        self.raising_tconorm(tconorm.drastic, None, 3, TypeError)
        self.raising_tconorm(tconorm.drastic, None, None, TypeError)
        self.raising_tconorm(tconorm.drastic, 0, None, TypeError)
    ...
    def test_nilpotent_none(self):
        self.raising_tconorm(tconorm.nilpotent_max, None, 3, TypeError)
        self.raising_tconorm(tconorm.nilpotent_max, None, None, TypeError)
        self.raising_tconorm(tconorm.nilpotent_max, 0, None, TypeError)
    ...
    def test_einstein_none(self):
        self.raising_tconorm(tconorm.einstein_sum, None, 3, TypeError)
        self.raising_tconorm(tconorm.einstein_sum, None, None, TypeError)
        self.raising_tconorm(tconorm.einstein_sum, 0, None, TypeError)
